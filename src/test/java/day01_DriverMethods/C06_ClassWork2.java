...
public class C06_ClassWork2 {
    public static void main(String[] args) {
        ...
        driver.manage().window().maximize();  // her acilista objeden sonra ilk is maximize yapmak olsun
        driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(15)); // sayfadaki herbir web elementi icin
